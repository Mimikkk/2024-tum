...
def memo(type: MemoType = 'memory', hashstr: str = None, verbose: bool | int = False):
  ...
  :parameter type: Memoization type. Either 'file' or 'memory'. Defaults to 'memory'. Function can be passed as a parameter to specify memoization type.
        ...
        def wrapper(*args, **kwargs):
          ...
          if os.path.exists(dirpath):
            for file in os.listdir(dirpath):
              ...
              if verbose > 1: print(f'[memo::{fn.__name__}-{hash[:6]}...] Removing {file}.')
